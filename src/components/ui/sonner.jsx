    ...
    (<Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          actionButton:
            "group-[.toast]:bg-primary group-[.toast]:text-primary-foreground bg-black text-white",
          cancelButton:
            "group-[.toast]:bg-muted group-[.toast]:text-muted-foreground bg-black text-white",
        },
      }}
      {...props} />)
  );
